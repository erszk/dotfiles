...
(custom-set-variables
 ...
 '(org-agenda-files '("~/gdrive/chaffey/s19.org"))
	'(package-selected-packages
		 '(json-mode web-mode emmet emmet-mode rubik graphviz-dot-mode forth-mode hy-mode editorconfig lua-mode fountain-mode haskell-mode abc-mode yaml-mode csv-mode yasnippet aggressive-indent ace-link company agressive-indent markdown-mode expand-region which-key paradox use-package typit magit paredit slime))
